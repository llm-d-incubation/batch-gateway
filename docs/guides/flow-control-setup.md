...
- **`concurrency.global`**: This remains a hard global ceiling across endpoints. Keep it high enough to avoid becoming the first bottleneck, while per-endpoint AIMD reacts to localized overload.
