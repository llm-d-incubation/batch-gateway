...
func (m *MockBatchFilesClient) Store(ctx context.Context, fileName, folderName string, fileSizeLimit, lineNumLimit int64, reader io.ReadCloser) (*api.BatchFileMetadata, error) {
...
func (m *MockBatchFilesClient) Retrieve(ctx context.Context, location string) (io.ReadCloser, *api.BatchFileMetadata, error) {
